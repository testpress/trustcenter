...
export const metadata = {
  title: 'Security Tests — TLS / HTTPS Enforcement',
  description:
    'Ensure all TPStorage endpoints enforce HTTPS, have valid TLS certificates, and support strong ciphers (TLS 1.2+).',
}
...
Ensuring all connections to TPStorage endpoints are secure with HTTPS is critical for data confidentiality and integrity. This page contains tests to verify HTTP redirection, certificate validity, and strong TLS configuration.

---


## Test Case TLS-01 — HTTP access should be blocked or redirect to HTTPS {{ anchor: false }}
...
<details>
<summary>Show curl commands and steps</summary>
...
<details>
<summary>Show actual curl output</summary>
